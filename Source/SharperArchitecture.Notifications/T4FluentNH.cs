...
namespace FluentNHibernate.Automapping
{
    internal static class EntityExtensions
    {
        ...
        public static void AddOneToMany<TOne, TMany>(this TOne one,
            ...
            where TOne : SharperArchitecture.Domain.IEntity
            where TMany : SharperArchitecture.Domain.IEntity
        {
        ...
        public static void AddManyToMany<TMany, TMany2>(this TMany many,
            ...
            where TMany : SharperArchitecture.Domain.IEntity
            where TMany2 : SharperArchitecture.Domain.IEntity
        {
        ...
        public static void SetOneToOne<TOne, TOne2>(this TOne one,
            ...
            where TOne : SharperArchitecture.Domain.IEntity
            where TOne2 : SharperArchitecture.Domain.IEntity
        {
