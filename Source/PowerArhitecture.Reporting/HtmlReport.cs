...
using PowerArhitecture.Reporting.Templates;
using RazorEngine;
...
namespace PowerArhitecture.Reporting
{
    public class HtmlReport : BaseReport<HtmlReportSettings>
    {
        static HtmlReport()
        {
            using (var stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("PowerArhitecture.Reporting.Templates.TableReport.cshtml"))
