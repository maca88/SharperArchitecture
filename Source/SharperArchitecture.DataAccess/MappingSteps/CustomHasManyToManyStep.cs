...
namespace SharperArchitecture.DataAccess.MappingSteps
{
    public class CustomHasManyToManyStep : IAutomappingStep
    {
        ...
        private static Member GetInverseProperty(Member member)
        {
            ...
            return argument.GetProperties(BindingFlags.Instance | BindingFlags.NonPublic | BindingFlags.Public)
                           .Select(x => x.ToMember())
        ...
        private void ConfigureModel(Member member, CollectionMapping mapping, ClassMappingBase classMap, System.Type parentSide)
        {
        ...
        static ICollectionRelationshipMapping CreateManyToMany(Member property, System.Type child, System.Type parent)
        {
        ...
        public void Map(ClassMappingBase classMap, Member member)
        {
            ...
            var parentSide = _cfg.GetParentSideForManyToMany(member.DeclaringType, inverseProperty.DeclaringType);
