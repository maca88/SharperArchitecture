...
namespace SharperArchitecture.Authentication.StartupTasks
{
    ...
    //        var xsdStream = Assembly.GetExecutingAssembly().GetManifestResourceStream("SharperArchitecture.Authentication.Rights.xsd");
    //        if(xsdStream == null)
