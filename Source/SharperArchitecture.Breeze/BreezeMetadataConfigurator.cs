...
using SharperArchitecture.Breeze.Attributes;
...
namespace SharperArchitecture.Breeze
{
    public class BreezeMetadataConfigurator : IEventHandler<BreezeMetadataBuiltEvent>
    {
        ...
        public static void AddNullableProperties(IEnumerable<string> propNames)
        {
            if (_configured)
            {
                throw new SharperArchitectureException("Cannot add nullable properties to BreezeMetadataConfigurator as it is locked. " +
