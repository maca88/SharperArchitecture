...
namespace PowerArhitecture.DataAccess.Configurations
{
    public static class DatabaseConfigurationKeys
    {
        ...
        public const string HbmMappingsPath = "PowerArhitecture.Database.HbmMappingsPath:string";
        ...
        public const string ConventionsRequiredLastModifiedProperty = "PowerArhitecture.Database.Conventions.RequiredLastModifiedProperty:bool";
    }
}
